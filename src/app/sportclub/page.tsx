      ...
      <main className="flex flex-1 flex-col px-6 py-6 md:flex-row md:items-start md:gap-10 md:px-10 md:py-10">
        ...
        <div className="mt-6 flex flex-1 flex-col justify-start md:mt-0 md:max-w-md">
          ...
          <button
            ...
            className="mt-8 flex h-button-primary w-full items-center justify-center rounded-xl bg-amber-600 px-6 text-lg font-semibold text-white transition hover:bg-amber-500 md:text-xl disabled:opacity-70 disabled:pointer-events-none"
          >
